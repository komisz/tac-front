# TACTICAL-FRONTEND [![Storybook](https://cdn.jsdelivr.net/gh/storybookjs/brand@main/badge/badge-storybook.svg)](https://komisz.github.io/tac-front)
...
First, head over to https://github.com/komisz/tac-front/settings/actions and under the `Workflow permissions`
...
Next, head over to https://github.com/komisz/tac-front/settings/branches and add a few branch protection rules.
...
Next, head over to https://github.com/komisz/tac-front/settings/pages and make sure the `Source` is set
to `GitHub Actions`.
...
For now, go to https://github.com/komisz/tac-front/settings/environments and create the following environments:
...
Navigate to https://github.com/komisz/tac-front/actions/workflows/ephemeralDeploy.yml and click the "Run workflow"
button.
...
```bash
 npx cdk deploy tac-front-ephemeral -O /tmp/deployment.result.json \
...
It can be either `tac-front-ephemeral` or `tac-front-production`.
...
[gh-variables]: https://github.com/komisz/tac-front/settings/variables/actions

[gh-secrets]: https://github.com/komisz/tac-front/settings/secrets/actions
